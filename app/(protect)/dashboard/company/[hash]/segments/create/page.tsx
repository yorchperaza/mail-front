...
export default function SegmentCreatePage() {
    ...
    const [status, setStatus] = useState<string>(''); // '' means ignore
    ...
    function toggleInList(id: number) {
        ...
        // if moving to "in", ensure it's not also in "not in"
        ...
        <div className="max-w-5xl mx-auto p-6 space-y-6">
            ...
            {preview && (
                <div className="bg-white border rounded-lg p-4 space-y-3">
                    ...
                    <div className="text-sm text-gray-600">
                        This is a dry run. Use the <b>Save</b> button above if you changed the definition. You can later open this segment to
                        run a full build (non-dry) and use it in campaigns.
                    </div>
                </div>
            )}
