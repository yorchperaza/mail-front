...
const SNIPPETS: { label: string; html: string; text: string }[] = [
    {
...
export default function TemplateEditPage() {
    ...
    const previewHtml = useMemo(() => {
        try {
            if (mode === 'text') {
                ...
                return `<pre style="white-space:pre-wrap;font-family:ui-monospace,Menlo,monospace;font-size:14px;line-height:1.4;margin:0">${escapeHtml(t)}</pre>`;
            }
    ...
    async function saveTemplate(redirect: 'back' | 'stay') {
    ...
    if (loadErr)
        return (
            <div className="p-6 text-center">
                ...
                <button onClick={() => router.push(`/dashboard/company/${hash}/templates`)} className="mt-3 inline-flex items-center px-3 py-2 rounded border">
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={onDelete} className="inline-flex items-center px-3 py-2 rounded border text-red-600 hover:bg-red-50">
            ...
            <div className="bg-white border rounded-lg p-4">
                <div className="grid md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <div className="mt-1">{toLocale(createdAt)}</div>
                    </div>
                    <div>
            ...
            <div className="bg-white border rounded-lg p-4 space-y-4">
                ...
                {mode === 'html' ? (
                    <div className="border rounded overflow-hidden">
                        ...
                        <div className="p-0">
                            {CodeMirror ? (
                                <CodeMirror value={html} height="420px" onChange={(v) => setHtml(v)} />
                            ) : (
                                <textarea
                                    value={html}
